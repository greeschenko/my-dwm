...
static const char normfgcolor[]          = "#CCC2C2";
static const char selbordercolor[]       = "#ff575f";
static const char selbgcolor[]           = "#444444";
static const char selfgcolor[]           = "#ff575f";
...
static const char *dmenucmd[] = { "dmenu_run", "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-w", "904", "-x", "226", "-y", "300", NULL };
